...
public class MoneyStackHolder : StackView
{
    ...
    protected override Vector3 CalculateAddEndPosition(Transform container, Transform stackable)
    {
        ...
        return Vector3.up * count * 0.05f + horizontalOffset;
    }

    protected override Vector3 CalculateEndRotation(Transform container, Transform stackable) => Vector3.up * Random.Range(-10, 10);
