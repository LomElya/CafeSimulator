public class HasOrderByCashDeskTransition : Transition
{
    private readonly WaitState _stateParent;

    public HasOrderByCashDeskTransition(CustomerStateType traterState, WaitState stateParent) : base(traterState)
    {
